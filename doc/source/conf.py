# -*- coding: utf-8 -*-
#
# Graph constrained group testing documentation build configuration file, created by
...
project = u'Graph constrained group testing'
copyright = u'2014, Bartłomiej Antosik'
